...
```
QUERY scaninfo(MS2DATA) WHERE MS2PROD=60.0808:TOLERANCEPPM=20:INTENSITYPERCENT=1 AND MS2PROD=85.0284:TOLERANCEPPM=20:INTENSITYPERCENT=50 AND MS2PROD=144.1019:TOLERANCEPPM=20:INTENSITYPERCENT=1
```
